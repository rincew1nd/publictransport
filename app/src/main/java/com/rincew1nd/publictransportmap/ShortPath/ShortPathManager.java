...
//import com.rincew1nd.publictransportmap.Models.Unscheduled.Route;
//
...
//        UnscheduledTransport transportMap = MapMarkerManager.GetInstance()._transportMap;
//        int maxId = 0;
//
...
//        {
//            for (Station station : transportMap.stations)
//            {
//                _graphNodes.put(station.Id, new GraphNode(station));
//                if (station.Id > maxId)
//                    maxId = station.Id;
//            }
//
